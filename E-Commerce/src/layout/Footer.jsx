  ...
  return (
    <footer className="">
      <div className="bg-gray-500">
        <div className="container mx-auto my-10 flex flex-col md:flex-row justify-between p-8">
      ...
      <div className="bg-gray-200">
        <div className="mt-10 pt-6 container  px-28  mx-auto py-8 md:flex text-center">
